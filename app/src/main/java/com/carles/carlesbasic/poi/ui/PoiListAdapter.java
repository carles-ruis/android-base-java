...
public class PoiListAdapter extends RecyclerView.Adapter<PoiListAdapter.PoiListViewHolder> {
    ...
    private List<com.carles.carlesbasic.poi.model.Poi> poiList = new ArrayList<>();
    ...
    public PoiListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new PoiListViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_poi_list, parent, false));
    }
    ...
    public void setItems(List<com.carles.carlesbasic.poi.model.Poi> poiList) {
        this.poiList.clear();
    ...
    class PoiListViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBindView(com.carles.carlesbasic.poi.model.Poi item) {
    ...
    interface PoiListAdapterListener {
        void onPoiClicked(com.carles.carlesbasic.poi.model.Poi poi);
    }
}
